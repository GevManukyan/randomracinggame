...
function init()
    ...
    function tick1(){
       sec = sec + (Math.random()*4);
        div.style.margin = `0px ${sec}px`;
    }  
    function ini()
    {
        sec1 = 0;
    ...
    function tick(){
       sec1 = sec1+(Math.random()*4);
        div2.style.margin = `0px ${sec1}px`;
    }  
    function ini7()
    {
        sec2 = 0;
    ...
    function tick7(){
       sec2 = sec2+(Math.random()*4);
        div3.style.margin = `0px ${sec2}px`;
    }  
